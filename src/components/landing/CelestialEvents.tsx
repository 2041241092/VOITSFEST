      ...
      <div className="relative group py-10 w-full flex overflow-hidden max-w-container-max mx-auto">
        <div className="scroll-track">
          <div className="flex gap-gutter pr-[24px] shrink-0">
            {/* BPC */}
            <div className="glass-card rounded-2xl p-stack-lg glow-effect group cursor-pointer w-[300px] md:w-[400px] flex-shrink-0 flex flex-col">
              ...
              <div className="flex items-center space-x-4 mb-stack-md">
                ...
                <h3 className="font-headline-md text-headline-md text-on-surface group-hover:text-primary transition-colors">BPC</h3>
              </div>
              <p className="font-body-md text-tertiary">Business Plan Competition for the visionary innovators of tomorrow.</p>
            </div>
            ...
            <div className="glass-card rounded-2xl p-stack-lg glow-effect group cursor-pointer w-[300px] md:w-[400px] flex-shrink-0 flex flex-col">
              ...
              <div className="flex items-center space-x-4 mb-stack-md">
                <Trophy className="w-9 h-9 text-secondary-fixed" />
                <h3 className="font-headline-md text-headline-md text-on-surface group-hover:text-primary transition-colors">BCC</h3>
              </div>
              <p className="font-body-md text-tertiary">Coding challenges that push the boundaries of logical space.</p>
            </div>
            ...
            <div className="glass-card rounded-2xl p-stack-lg glow-effect group cursor-pointer w-[300px] md:w-[400px] flex-shrink-0 flex flex-col">
              ...
              <div className="flex items-center space-x-4 mb-stack-md">
                ...
                <h3 className="font-headline-md text-headline-md text-on-surface group-hover:text-primary transition-colors">Entrepreneurship Seminar</h3>
              </div>
              <p className="font-body-md text-tertiary">Insights from industry stars and tech constellations.</p>
            </div>
            ...
            <div className="glass-card rounded-2xl p-stack-lg glow-effect group cursor-pointer w-[300px] md:w-[400px] flex-shrink-0 flex flex-col">
              ...
              <div className="flex items-center space-x-4 mb-stack-md">
                ...
                <h3 className="font-headline-md text-headline-md text-on-surface group-hover:text-primary transition-colors">Tenant Registration</h3>
              </div>
              <p className="font-body-md text-tertiary">Explore earthly delights and secure your cosmic merchandise spot.</p>
            </div>
            
            {/* ColorFun Run */}
            <div className="glass-card rounded-2xl p-stack-lg glow-effect group cursor-pointer w-[300px] md:w-[400px] flex-shrink-0 flex flex-col relative overflow-hidden">
              ...
              <div className="relative z-10 flex items-center space-x-4 mb-stack-md">
                ...
                <h3 className="font-headline-md text-headline-md text-on-surface group-hover:text-primary transition-colors">ColorFun Run</h3>
              </div>
              <p className="font-body-md text-tertiary relative z-10">A vibrant dash through cosmic dust. Experience the physical manifestation of our parade of stars.</p>
            </div>
            ...
            <div className="glass-card rounded-2xl p-stack-lg glow-effect group cursor-pointer w-[300px] md:w-[400px] flex-shrink-0 flex flex-col">
              ...
              <div className="flex items-center space-x-4 mb-stack-md">
                ...
                <h3 className="font-headline-md text-headline-md text-on-surface group-hover:text-primary transition-colors">Festival</h3>
              </div>
              <p className="font-body-md text-tertiary">The grand finale. A spectacular celebration to close the cosmic parade.</p>
            </div>
          </div>
